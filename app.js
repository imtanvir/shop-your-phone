...
if (dataperameter.length <= 20) { showItemNumEnd=20; document.getElementById('show-more-btn').setAttribute("class", "d-none btn btn-primary" ); } else if (dataperameter.length> 20) {
    showItemNumEnd = 20;
